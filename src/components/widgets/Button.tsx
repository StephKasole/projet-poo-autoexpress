...
function Button({
  ...
  const showMsg = () =>
    showToast({ message: "Veuillez ajouter une action ", typeToast: "dark" });
  const loadingtext = "";

  return (
    <button
      style={{ backgroundColor: styleTheme.colors.Blue }}
    ...
    >
      ...
      <span className='text'>{isLoadingInfo ? "Telechargement..." : text}</span>
